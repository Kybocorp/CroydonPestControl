...
namespace CroydonPestControl.API.Controllers
{
    ...
    public class BlocksController : Controller
    {
        ...
        [HttpGet("{blockCycleId}")]
        public async Task<IActionResult> GetUnassigned(int blockCycleId)
        {
            _logger.LogInformation("Calling Get Unassigned from BlocksController");
            return Ok(await _blocksAppService.GetUnassignedBlocksByBlockCycleIdAsync(blockCycleId));
        }
