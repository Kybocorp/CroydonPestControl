...
namespace CroydonPestControl.API
{
    public class MappingProfile: Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<AppServices.Models.UnassignedBlockViewModel, Infrastructure.Models.UnassignedBlockViewModel>().ReverseMap();
            ...
            CreateMap<AppServices.Models.PropertiesViewModel, Infrastructure.Models.PropertiesViewModel>().ReverseMap();
